...
class Teacher(models.Model):
    ...
    role = models.SmallIntegerField('职位', choices=role_choices, default=0)
    title = models.CharField(max_length=64, verbose_name="职位、职称")
    signature = models.CharField(max_length=255, help_text="导师签名", blank=True, null=True)
    image = models.CharField(max_length=128)
    brief = models.TextField(verbose_name='个人简历', max_length=1024)
...
class Course(models.Model):
    ...
    sub_category = models.ForeignKey("CourseSubCategory", verbose_name='课程子类', on_delete=models.CASCADE)  #
    ...
    def __str__(self):
        return '{}({})'.format(self.name, self.get_course_type_display())
...
class CourseDetail(models.Model):
    ...
    course_slogan = models.CharField(verbose_name='课程口号', max_length=125, blank=True, null=True)
